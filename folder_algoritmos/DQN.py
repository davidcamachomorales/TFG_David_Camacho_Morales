...
scenario_config = pd.read_csv(f'../config_files/scenarios_config_{timeframe}_ablation.csv')
...
# Save summary
df_batch_summary.to_csv('../RL_outputs/results/DQN_batch_summary.csv', index=False)
# Save all seed results 
df_all_seeds = pd.DataFrame(all_seed_results)
df_all_seeds.to_csv('../RL_outputs/results/DQN_all_seed_results.csv', index=False)